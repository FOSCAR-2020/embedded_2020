...
$(TARGET): main.c car_lib.c  v4l2.lo display-kms.lo util.lo vpe-common.lo input_cmd.lo drawing.lo opencv_use.lo function.lo
	$(CC) $(CFLAGS) -o $@ main.c car_lib.c v4l2.lo display-kms.lo util.lo vpe-common.lo input_cmd.lo drawing.lo opencv_use.lo function.lo $(LDFLAGS)
...
function.lo: function.cpp function.h
	$(CXX) -c $(CXXFLAGS) -o $@ function.cpp
